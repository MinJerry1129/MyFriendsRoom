//
//  ProposalReceivedListCell.swift
//  MyFriendsRoom
//
...
class ProposalReceivedListCell: UITableViewCell {
    ...
    let profileImageView: UIImageView = {
        ...
        //let tapRecognizer = UITapGestureRecognizer(target: self, action: #selector(ProposalsReceivedController.viewProfile))
    ...
    let viewButton: UIButton = {
        ...
        button.translatesAutoresizingMaskIntoConstraints = false
        //button.setTitleColor(CustomColors.commonBlue1, for: .normal)
        button.addTarget(self, action: #selector(ProposalsReceivedController.viewProfile), for: .touchUpInside)
        return button
    }()

...
@IBDesignable open class RangeSeekSlider: UIControl {
   ...
   //     element.accessibilityTraits = UIAccessibilityTraits.adjustable
    ...
    open override var intrinsicContentSize: CGSize {
        return CGSize(width: UIViewNoIntrinsicMetric/* UIView.noIntrinsicMetric*/, height: 65.0)
    }
    ...
    private func animate(handle: CALayer, selected: Bool) {
        ...
        CATransaction.setAnimationTimingFunction(CAMediaTimingFunction(name: kCAMediaTimingFunctionEaseInEaseOut/*  CAMediaTimingFunctionName.easeInEaseOut*/))
